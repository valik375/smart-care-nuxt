    ...
    <div class="blog-section__container container">
      <div class="blog-section__wrapper">
        <SectionTitle
          ...
          text="У нашому блозі ми пишемо про цікавості та останні новинки зі світу розумних будинків та технологій."
        />
      </div>
      <div class="blog-section__list">
        ...
        <div class="blog-section__swiper-prev swiper-prev" @click="prevSlide">
        ...
        <div class="blog-section__swiper-next swiper-next" @click="nextSlide">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default defineComponent({
  ...
  components: {PostCard, SectionTitle},

  methods: {
    prevSlide() {
      document.querySelector('.blogSection').swiper.slidePrev()
    },
    nextSlide() {
      document.querySelector('.blogSection').swiper.slideNext()
    },
  },
  ...
  computed: {
    swiperOptions() {
      return  {
        slidesPerView: 1.1,
        spaceBetween: 16,
        slideNextClass: '.blog-section__swiper-next',
        slidePrevClass: '.blog-section__swiper-prev',
        breakpoints: {
          760: {
            slidesPerView: 2,
          },
