  ...
  <section class="equipment">
    <div class="equipment__container container">
      ...
      <div class="equipment__swiper-wrapper">
        ...
        <div class="equipment__swiper-prev swiper-prev" @click="prevSlide">
        ...
        <div class="equipment__swiper-next swiper-next" @click="nextSlide">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
.equipment__swiper-prev,
.equipment__swiper-next {
  display: none;
